...
- /Vektorski sat/ je preslikavanje $v: S \to \mathbb{N}^k, k \in \mathbb{N}$ koje zadovoljava: $$ (\forall s,t \in S)(s \to t \iff s.v < t.v) $$, gdje je $s.v$ vektor pridruzen stanju $s$
