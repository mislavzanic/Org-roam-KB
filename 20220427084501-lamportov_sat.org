...
- koji put je zgodnije „udarati” vremenske žigove stanjima procesa, a ne događajima
  - logički sat stoga također zadovoljava i ovakav uvjet: $$(\forall s,t \in S)(s \to t \implies C(s) < C(t))$$, $S$ je *skup stanja*
...
- Svako stanje “žigošemo” parom $(s.c, s.p)$, $s$ je stanje
