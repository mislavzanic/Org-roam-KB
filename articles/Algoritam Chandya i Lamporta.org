:PROPERTIES:
:ID:       2f8fc802-fa93-4dcc-9df9-aaac9b05185f
:END:
...
* Opis
- algoritam svakom _procesu_ pridružuje “boju” koja može biti bijela ili crvena
...
* Svojstva
- promjena boje u jednom procesu _odmah se dojavljuje svim susjednim procesima_
...
- metoda ~handleMsg()~ najprije implementira postupak kod prijema poruke /marker/
  ...
  - prijem poruke /marker/ znači da je neki proces $P_{src}$ postao crven i poslao poruku niz sve svoje kanale da je on pocrvenio
    - lokalni (ovaj) proces zbog toga pocrveni i zatvara kanal sa $P_{src}$
