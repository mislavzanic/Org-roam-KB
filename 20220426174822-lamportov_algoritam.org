...
- lamportov algoritam spada među algoritme za međusobno isključivanje koji su zasnovani na vremenskim žigovima

* Opis
- Svaki proces održava logički sat (za vremensko žigosanje) i red (za spremanje zahtjeva za resursom)
...
- Pretpostavlja se FIFO uređaj poruka po komunikacijskim kanalima
